    ...
    <div className="body">
      <div className="body__wrapper">
        ...
        <div className="body__content">
          ...
          <section className="body__productsSection">
                ...
                <div>
                  ...
                  <div className="products__item bodySingapore">
                    <div className="products__item bodySingaporeContent">
                      <div className="products__item bodyNameSingapore">
                        Сингапур
                      </div>
                      <div className="products__item bodySizeSingapore">
                        205 г
                      </div>
                ...
                <div>
                  ...
                  <div className="products__item bodyCalifornia">
                    <div className="products__item bodyCaliforniaContent">
                      ...
                      <div className="products__item bodySizeCalifornia">
                        265 г
                      </div>
                ...
                <div>
                  ...
                  <div className="products__item bodyMoscow">
                    <div className="products__item bodyMoscowContent">
                      <div className="products__item bodyNameMoscow">
                        Москва
                      </div>
